...
const Card = () => {
    return (
        <div className="ring-foreground/15 bg-background relative z-10 flex aspect-video w-full flex-col justify-between overflow-hidden rounded-2xl border border-transparent px-6 py-5 shadow-xl shadow-sky-950/10 ring-1">
