...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeft className="size-4 text-secondary" />
...
const sidebarMenuButtonVariants = cva(
  [
    "peer/menu-button [&>svg]:size-5 [&>svg]:shrink-0",
    "flex w-full items-center gap-2 rounded-lg px-2 py-2.5 text-left text-base/6 font-medium text-zinc-950 sm:py-2 sm:text-base/5 text-primary",
